...
<template>
    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            <Link
                v-if="$page.props.auth.logged_in_guard"
        ...
        <section class="bg-gray-900 text-white">
            ...
            >
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    >
                        Streamline Workforce Dynamics,

                        <span class="sm:block"> Maximize Impact. </span>
                    </h1>

                    <p class="mx-auto mt-4 max-w-xl sm:text-xl/relaxed">
                        EmployeeOps empowers organizations by streamlining
                        workforce operations, fostering seamless collaboration
                        and efficient resource allocation. Harness the full
                        potential of your team to maximize productivity and
